...
OhdsiRTools::checkUsagePackage("LTRAvsICS")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/LTRAvsICS.pdf")
shell("R CMD Rd2pdf ./ --output=extras/LTRAvsICS.pdf")
...
OhdsiRTools::createRenvLockFile("LTRAvsICS")
